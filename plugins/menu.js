...
Asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://www.pixelstalk.net/wp-content/uploads/2016/03/madrox-wallpaper-HD-dowload.jpg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨️venomallu✨️━━━━━⛦
𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 𝐚 venomallu 𝐛𝐨𝐭.
            *madrox*
■□■□■□■□■□■□■□■□■□■□
♕ *𝙈𝙚𝙙𝙞𝙖 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨* ♕
➡️𝘾𝙤𝙢𝙢𝙖𝙣𝙙➜ -song <text>
